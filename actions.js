				...
				options: [
					{
						...
						id: 'input',
						default: 0,
						tooltip: 'Select the input number you want to load',
						choices: [
							{ id: 0, label: 'Black' },
							{ id: 1, label: 'Input 1' },
							{ id: 2, label: 'Input 2' },
					...
					},
					{
						...
						id: 'layer',
						default: 0,
						tooltip: 'Select in wich layer the input should be loaded',
						choices: [
							{ id: 0, label: 'Layer A' },
							{ id: 1, label: 'Layer B' },
							{ id: 2, label: 'Layer C' },
			...
			loadpreset: {
				...
				options: [
					...
					},
					{
						...
						id: 'destscreen',
						default: '1',
						tooltip: 'Enter the number of the screen where the memory should be loaded to (1 to 8)',
						regex: '/^0*[1-8]$/',
					},
					{
						type: 'dropdown',
				...
				options: [
					{
						...
						default: '',
						tooltip:
							"Enter any command you like in plain ASCII. Beware of correct syntax, you mustn't enter the linebreak at the end of the command.",
						regex: '/^[\\w,]+$/i',
					},
				],
			},
